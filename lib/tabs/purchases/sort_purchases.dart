...
class SortPurchasesButton extends StatelessWidget {
  const SortPurchasesButton({Key? key,
    required this.ref,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton(
      ...
      itemBuilder: (BuildContext context) {
        return Constants.sortByPurchases.entries.map((e) {
      ...
      onSelected: (dynamic value) {
        ...
        ref.read(sortByPurchasesTextProvider.notifier).update((state) => Constants.sortByPurchases[value].toString());
