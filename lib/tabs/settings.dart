...
class _SettingsState extends ConsumerState<Settings> {
  ...
  Widget _category1Dropdown(List<Category> categories) {
    // Determine if _specialCategory.id is valid, otherwise use null for display
    final selectedCategoryIdAfterFilter = categories.any((f) => f.id == _specialCategory.id1) ? _specialCategory.id1 : null;
    ...
    return Container(
        ...
        child: DropdownButtonFormField(
            ...
            value: selectedCategoryIdAfterFilter,
